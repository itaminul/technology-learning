...
export default function Home() {
  return (
    <div className="bg-slate-50">
      <section>
        <MaxWidthWrapper
          className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gp-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52"
        ...
        >
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              ...
              />
              <img src="" className='absolute s-20 -left-6 -bottom-6 select-none' />
            </div>
          </div>
        </MaxWidthWrapper>
      </section>
